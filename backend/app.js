...
// }) 
 ...
 app.use(express.static(path.join(__dirname, "https://fabulous-hotteok-fed63e.netlify.app/")));

app.get("*",(req,res) =>{
    res.sendFile(path.resolve(__dirname, "https://fabulous-hotteok-fed63e.netlify.app/"));
}) 
